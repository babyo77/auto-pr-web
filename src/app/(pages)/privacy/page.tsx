  ...
  return (
    <div className="container pt-32 mx-auto px-4 max-w-6xl px-4">
      ...
      <div className="space-y-6">
        <section>
          <p>
            This privacy policy sets out how M3labs uses and protects any
            information that you give M3labs when you visit their website and/or
            agree to purchase from them.
          </p>
          <p className="mt-4">
            M3labs is committed to ensuring that your privacy is protected.
          ...
          <p className="mt-4">
            M3labs may change this policy from time to time by updating this
        ...
        <section className="mt-12">
          ...
          <p className="text-sm text-gray-600 mb-8">
            Last updated on Mar 5th 2025
          </p>

          <p>
            M3labs believes in helping its customers as far as possible, and has
          ...
          <ul className="list-disc pl-8 mt-4 space-y-2">
            ...
            <li>
              M3labs does not accept cancellation requests for perishable items
            ...
            <li>
              ...
              at his own end. This should be reported within 2-3 days of receipt
              of the products.
            </li>
            <li>
              ...
              of our customer service within 2-3 days of receiving the product.
            ...
            <li>
              In case of any Refunds approved by M3labs, it'll take 3-4 days for
