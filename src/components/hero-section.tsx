      ...
      <section>
        <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44 max-md:pt-32">
          <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
            ...
            <Image
              className="-z-10 order-first ml-auto h-62 w-full object-cover  sm:h-96 lg:absolute lg:inset-0 lg:-right-20 lg:-top-56 lg:order-last lg:h-max lg:w-2/3 lg:object-contain "
